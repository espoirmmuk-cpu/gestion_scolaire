...
<x-slot name="header">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">
            Créer une période scolaire pour une année académique.
        </p>
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Renseignez les informations de la nouvelle période scolaire.
                </p>

            </div>


            <form action="{{ route('periodes-scolaires.store') }}"
                  method="POST">
