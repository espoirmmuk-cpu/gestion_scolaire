...
<x-slot name="header">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">
            Enregistrer l'inscription d'un élève pour une année scolaire.
        </p>
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Les frais scolaires seront générés automatiquement après l'inscription.
                </p>

            </div>


            <form action="{{ route('inscriptions.store') }}"
                  method="POST">
                        ...
                        <div>
                            ...
                            <select name="statut"
                                ...
                                <option value="INSCRIT"
                                    {{ old('statut', 'INSCRIT') === 'INSCRIT' ? 'selected' : '' }}>
